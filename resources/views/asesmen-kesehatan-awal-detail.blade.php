<x-app-layout>
    ...
    <div class="participant-detail-page" x-data="{ showSavePopup: false }">
        ...
        <form class="participant-detail-card" method="POST">
            ...
            KEMBALI
            ================================================== --}}
            <a href="{{ route('asesmen-instruktur-detail') }}" class="btn-back">
            ...
            <div class="form-action">
                ...
                {{-- SELANJUTNYA --}}
                <a href="{{ route('case-conference-detail') }}" class="btn">
                    Selanjutnya
                </a>
            ...
            <div class="save-modal-overlay">
                ...
                <div class="save-modal">
                    ...
                    <button type="button" class="save-modal-button"
                        @click="window.location.href = '{{ route('asesmen-kesehatan-awal-detail') }}'">
                        OK
                    </button>
