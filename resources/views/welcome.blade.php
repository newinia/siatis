        ...
        <style>
            ...
            @layer theme {
                ...
                :host {
                    ...
                    --color-muted-50: oklch(98.5% .002 247.839);
                    --color-muted-100: oklch(96.7% .003 264.542);
                    --color-muted-200: oklch(92.8% .006 264.531);
                    --color-muted-300: oklch(87.2% .01 258.338);
                    --color-muted-400: oklch(70.7% .022 261.325);
                    --color-muted-500: oklch(55.1% .027 264.364);
                    --color-muted-600: oklch(44.6% .03 256.802);
                    --color-muted-700: oklch(37.3% .034 259.733);
                    --color-muted-800: oklch(27.8% .033 256.848);
                    --color-muted-900: oklch(21% .034 264.665);
                    --color-muted-950: oklch(13% .028 261.692);
            ...
            @layer utilities {
                ...
                .antialiased {
                    ...
                    -moz-osx-font-smoothing: mutedscale
                }
                ...
                .ring-muted-300 {
                    --tw-ring-color: var(--color-muted-300)
                }

                .filter {
                    filter: var(--tw-blur, ) var(--tw-brightness, ) var(--tw-contrast, ) var(--tw-mutedscale, ) var(--tw-hue-rotate, ) var(--tw-invert, ) var(--tw-saturate, ) var(--tw-sepia, ) var(--tw-drop-shadow, )
                }
                ...
                .active\:text-muted-500:active {
                    color: var(--color-muted-500)
                }

                .active\:text-muted-700:active {
                    color: var(--color-muted-700)
                }

                .active\:text-muted-800:active {
                    color: var(--color-muted-800)
                }
                ...
                @media(prefers-color-scheme:dark) {
                    ...
                    @media(hover:hover) {
                        ...
                        .dark\:hover\:text-muted-200:hover {
                            color: var(--color-muted-200)
                        }

                        .dark\:hover\:text-muted-300:hover {
                            color: var(--color-muted-300)
                        }
                    }
                    ...
                    .dark\:active\:bg-muted-700:active {
                        background-color: var(--color-muted-700)
                    }

                    .dark\:active\:text-muted-300:active {
                        color: var(--color-muted-300)
                    }
                }
