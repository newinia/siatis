            ...
            <tbody>
                ...
                @foreach ($students as $index => $student)
                    ...
                    <tr
                        ...
                        data-nik="{{ strtolower($student['nik']) }}"
                        data-ppks="{{ strtolower($student['ppks']) }}"
                        data-tahapan="{{ strtolower($student['tahapan']) }}"
                        data-hasil="{{ strtolower($student['hasil']) }}"
                        data-tanggal="{{ $student['tanggal'] }}"
                    >
                        ...
                        <td>
                            ...
                            @if ($student['status'] === 'accepted')
                                ...
                                <a href="{{ route('case-conference-detail') }}"
                            ...
                            @elseif ($student['status'] === 'instructor')
                                ...
                                <a href="{{ route('asesmen-instruktur-detail') }}"
