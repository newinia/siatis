<x-app-layout>
    ...
    <div class="participant-detail-page" x-data="{ showSavePopup: false }">
        ...
        <form class="participant-detail-card" method="POST">
            ...
            KEMBALI
            ================================================== --}}
            <a href="{{ route('data-detail') }}" class="btn-back">
            ...
            <div class="detail-section">
                ...
                <div class="assessment-grid">
                    ...
                    <div class="detail-field">
                        ...
                        <label for="status_kepesertaan">
                            Baznas / Non Baznas
                        </label>

                        <select id="status_kepesertaan" name="status_kepesertaan">
                    ...
                    <div class="detail-field">
                        ...
                        <label for="petugas_instruktur">
                            Petugas Asesmen Instruktur
                        </label>

                        <select id="petugas_instruktur" name="petugas_instruktur">

                            <option value="">
                                Pilih Petugas Asesmen Instruktur
                            </option>
                    ...
                    <div class="detail-field">
                        ...
                        <select id="hasil_asesmen" name="hasil_asesmen">
                            ...
                            <option value="">
                                Pilih Hasil Asesmen Instruktur
                            </option>
            ...
            <div class="form-action">
                ...
                {{-- SELANJUTNYA --}}
                <a href="{{ route('asesmen-kesehatan-awal-detail') }}" class="btn">
                    Selanjutnya
                </a>
            ...
            <div class="save-modal-overlay">
                ...
                <div class="save-modal">
                    ...
                    <button type="button" class="save-modal-button"
                        @click="window.location.href = '{{ route('asesmen-instruktur-detail') }}'">
                        OK
                    </button>
