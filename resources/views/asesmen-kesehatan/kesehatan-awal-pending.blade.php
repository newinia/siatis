...
/* =========================================================
   DATA PENDING ASESMEN KESEHATAN AWAL
========================================================= */
...
.result-navigation a.active {
    ...
    color: #ffffff;
    box-shadow: 0 5px 12px rgba(99, 174, 0, .20);
}
...
.case-filter-button:focus {
    border-color: #97D94D;
    box-shadow: 0 0 0 3px rgba(151, 217, 77, .12);
}
...
.action-detail:hover {
    ...
    border-color: #c9dfba;
    color: #3e622b;
    box-shadow: 0 4px 10px rgba(79, 113, 57, .10);
}
...
<div class="case-conference-page">
    ...
    <div class="case-conference-header">
        ...
        <div>
            ...
            <h1>
                Data Pending Kesehatan Awal
            </h1>

            <p>
                Data PPKS yang telah menjalani Asesmen Kesehatan Awal
    ...
    <div class="result-navigation">
        ...
        <a href="{{ route('ppks.normal.asesmen-kesehatan.lulus') }}">
            Lulus
        </a>
        ...
        <a href="{{ route('ppks.normal.asesmen-kesehatan.tidak-lulus') }}">
            Tidak Lulus
        </a>
                ...
                @empty
                    ...
                    <tr>
                        ...
                        <td colspan="9">
                            ...
                            Tidak ada data Asesmen Kesehatan Awal
                            yang berstatus pending.
