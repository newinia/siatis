                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @if ($student['status'] === 'accepted')
                                    ...
                                    <a href="{{ route('data-detail') }}" class="result-badge result-accepted">
                                ...
                                @elseif ($student['status'] === 'rejected')
                                    ...
                                    <a href="{{ route('data-detail') }}" class="result-badge result-rejected">
                                ...
                                @elseif ($student['status'] === 'instructor')
                                    ...
                                    <a href="{{ route('case-conference.data-detail') }}" class="result-badge result-instructor">
                                ...
                                @elseif ($student['status'] === 'health')
                                    ...
                                    <a href="{{ route('data-detail') }}" class="result-badge result-health">
